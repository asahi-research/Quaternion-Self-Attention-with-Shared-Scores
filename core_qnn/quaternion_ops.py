...
KernelSize = Optional[Union[int, Sequence[int]]]
InitTuple = Tuple[np.ndarray, np.ndarray, np.ndarray, np.ndarray]
...
def quaternion_conv(input: torch.Tensor, r_weight: torch.Tensor, i_weight: torch.Tensor,
                    j_weight: torch.Tensor, k_weight: torch.Tensor, bias: Optional[torch.Tensor], stride: Any,
                    padding: Any, groups: int, dilatation: Any) -> torch.Tensor:
    """
...
def quaternion_transpose_conv(input: torch.Tensor, r_weight: torch.Tensor, i_weight: torch.Tensor,
                    j_weight: torch.Tensor, k_weight: torch.Tensor, bias: Optional[torch.Tensor], stride: Any,
                    padding: Any, output_padding: Any, groups: int, dilatation: Any) -> torch.Tensor:
    """
...
def quaternion_conv_rotation(input: torch.Tensor, zero_kernel: torch.Tensor, r_weight: torch.Tensor,
                    i_weight: torch.Tensor, j_weight: torch.Tensor, k_weight: torch.Tensor,
                    bias: Optional[torch.Tensor], stride: Any, padding: Any, groups: int,
                    dilatation: Any, quaternion_format: bool, scale: Optional[torch.Tensor] = None) -> torch.Tensor:
    """
...
def quaternion_transpose_conv_rotation(input: torch.Tensor, zero_kernel: torch.Tensor, r_weight: torch.Tensor,
                    i_weight: torch.Tensor, j_weight: torch.Tensor, k_weight: torch.Tensor,
                    bias: Optional[torch.Tensor], stride: Any, padding: Any, output_padding: Any, groups: int,
                    dilatation: Any, quaternion_format: bool) -> torch.Tensor:
    """
...
def quaternion_linear(input: torch.Tensor, r_weight: torch.Tensor, i_weight: torch.Tensor,
                      j_weight: torch.Tensor, k_weight: torch.Tensor,
                      bias: Union[torch.Tensor, bool, None] = True) -> torch.Tensor:
    """
...
def quaternion_linear_rotation(input: torch.Tensor, zero_kernel: torch.Tensor, r_weight: torch.Tensor,
                               i_weight: torch.Tensor, j_weight: torch.Tensor, k_weight: torch.Tensor,
                               bias: Optional[torch.Tensor] = None,
                               quaternion_format: bool = False, scale: Optional[torch.Tensor] = None) -> torch.Tensor:
    """
...
class QuaternionLinearFunction(torch.autograd.Function):
    ...
    @staticmethod
    def forward(ctx: Any, input: torch.Tensor, r_weight: torch.Tensor, i_weight: torch.Tensor,
                j_weight: torch.Tensor, k_weight: torch.Tensor,
...
def unitary_init(in_features: int, out_features: int, rng: RandomState,
                 kernel_size: KernelSize = None, criterion: str = 'he') -> InitTuple:
...
def random_init(in_features: int, out_features: int, rng: RandomState,
                kernel_size: KernelSize = None, criterion: str = 'glorot') -> InitTuple:
...
def quaternion_init(in_features: int, out_features: int, rng: RandomState,
                    kernel_size: KernelSize = None, criterion: str = 'glorot') -> InitTuple:
...
def create_dropout_mask(dropout_p: float, size: Sequence[int], rng: RandomState,
                        as_type: Any, operation: str = 'linear') -> torch.Tensor:
    if operation == 'linear':
...
def affect_init(r_weight: torch.Tensor, i_weight: torch.Tensor, j_weight: torch.Tensor,
                k_weight: torch.Tensor, init_func: Callable[..., InitTuple],
                rng: RandomState, init_criterion: str) -> None:
...
def affect_init_conv(r_weight: torch.Tensor, i_weight: torch.Tensor, j_weight: torch.Tensor,
                     k_weight: torch.Tensor, kernel_size: KernelSize,
                     init_func: Callable[..., InitTuple], rng: RandomState,
...
def get_kernel_and_weight_shape(operation: str, in_channels: int, out_channels: int,
                                kernel_size: Union[int, Sequence[int]]) -> Tuple[Union[int, Sequence[int]], Tuple[int, ...]]:
